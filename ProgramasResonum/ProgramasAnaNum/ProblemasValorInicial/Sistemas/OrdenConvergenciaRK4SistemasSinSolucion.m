function [O, E] = OrdenConvergenciaRK4SistemasSinSolucion(F, t0, T, Y0, N, tol)
% [O, E] = OrdenConvergenciaRK4SistemasSinSolucion(F, t0, T, Y0, N, tol)
% Obtiene el orden de convergencia del metodo de Runge-Kutta para sistemas sin solucion
% conocida
% PARAMETROS:
...
[Yk1, ~] = MetodoRK4Sistemas(F, t0, T, Y0, n);
n = n * 2;
[Yk2, ~] = MetodoRK4Sistemas(F, t0, T, Y0, n);
temp = Yk2(:, 1:2:end);
