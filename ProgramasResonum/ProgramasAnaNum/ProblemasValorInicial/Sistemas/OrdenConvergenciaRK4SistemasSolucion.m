function [O, E] = OrdenConvergenciaRK4SistemasSolucion(F, t0, T, Y0, N, Y, tol)
% [O, E] = OrdenConvergenciaRK4SistemasSolucion(F, t0, T, Y0, N, Y, tol)
% Obtiene el orden de convergencia del metodo de Runge-Kutta  para sistemas con solucion
% conocida
% PARAMETROS:
