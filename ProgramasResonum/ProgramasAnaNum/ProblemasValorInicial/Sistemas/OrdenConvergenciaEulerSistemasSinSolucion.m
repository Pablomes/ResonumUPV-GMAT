function [O, E] = OrdenConvergenciaEulerSistemasSinSolucion(F, t0, T, Y0, N, tol)
% [O, E] = OrdenConvergenciaEulerSistemasSinSolucion(F, t0, T, Y0, N, tol)
% Obtiene el orden de convergencia del metodo de sistemas de Euler sin solucion
% conocida
% PARAMETROS:
...
[Yk1, ~] = MetodoEulerSistemas(F, t0, T, Y0, n);
n = n*2;
[Yk2, ~] = MetodoEulerSistemas(F, t0, T, Y0, n);
temp = Yk2(:, 1:2:end);
