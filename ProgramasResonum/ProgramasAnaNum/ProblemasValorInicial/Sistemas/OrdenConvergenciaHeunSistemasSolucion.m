function [O, E] = OrdenConvergenciaHeunSistemasSolucion(F, t0, T, Y0, N, Y, tol)
% [O, E] = OrdenConvergenciaHeunSistemasSolucion(F, t0, T, Y0, N, Y, tol)
% Obtiene el orden de convergencia del metodo de sistemas de Heun con solucion
% conocida
% PARAMETROS:
