function [O, E] = OrdenConvergenciaRK4SinSolucion(f, t0, T, y0, N, tol)
% [O, E] = OrdenConvergenciaRK4Solucion(f, t0, T, y0, N, tol)
% Obtiene el orden de convergencia del metodo de Runge-Kutta sin solucion
% conocida
% PARAMETROS:
...
[yk1, ~] = MetodoRK4(f, t0, T, y0, n);
n = n * 2;
[yk2, ~] = MetodoRK4(f, t0, T, y0, n);
temp = yk2(1:2:end);
