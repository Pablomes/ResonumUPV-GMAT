function [O, E] = OrdenConvergenciaHeunSinSolucion(f, t0, T, y0, N, tol)
% [O, E] = OrdenConvergenciaHeunSolucion(f, t0, T, y0, N, y, tol)
% Obtiene el orden de convergencia del metodo de Heun sin solucion
% conocida
% PARAMETROS:
...
[yk1, ~] = MetodoHeun(f, t0, T, y0, n);
n = n * 2;
[yk2, ~] = MetodoHeun(f, t0, T, y0, n);
temp = yk2(1:2:end);
