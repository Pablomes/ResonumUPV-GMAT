function [O, E] = OrdenConvergenciaRK4Solucion(f, t0, T, y0, N, y, tol)
% [O, E] = OrdenConvergenciaRK4Solucion(f, t0, T, y0, N, y, tol)
% Obtiene el orden de convergencia del metodo de Runge-Kutta con solucion
% conocida
% PARAMETROS:
