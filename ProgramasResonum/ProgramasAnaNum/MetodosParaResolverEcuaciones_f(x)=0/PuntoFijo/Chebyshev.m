function [sol,incr,iter,ACOC] = Chebyshev (f,df,d2f,x0,tol,maxiter)
% [sol, incr, iter, ACOC] = Chebyshev(f, df, d2f, x0, tol, maxiter)
% Aproxima la solucion f(x) = 0 usando el metodo de punto fijo de Chebyshev
% PARAMETROS:
