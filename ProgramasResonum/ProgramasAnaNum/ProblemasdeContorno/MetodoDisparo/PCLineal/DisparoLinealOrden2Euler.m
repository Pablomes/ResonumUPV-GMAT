function [yk, xk] = DisparoLinealOrden2Euler(p, q, r, a, b, alpha, beta, N)
% [yk, xk] = DisparoLinealOrden2Euler(p, q, r, a, b, alpha, beta, N)
...
% de Dirichlet usando el metodo de Euler
% PARAMETROS:
...
U0 = [alpha; 0];
[U, ~] = MetodoEulerSistemas(FU, a, b, U0, N);

FV = @(x, V) [V(2); p(x) * V(2) + q(x) * V(1)];
V0 = [0;1];
[V, ~] = MetodoEulerSistemas(FV, a, b, V0, N);
