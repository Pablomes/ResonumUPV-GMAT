function [yk, xk] = DisparoLinealOrden2RK4(p, q, r, a, b, alpha, beta, N)
% [yk, xk] = DisparoLinealOrden2RK4(p, q, r, a, b, alpha, beta, N)
...
% de Dirichlet usando el metodo de Runge-Kitta
% PARAMETROS:
