function [sol, incr, iter, ACOC] = SOR2(A, b, x0, w, tol, maxiter)
% [sol, incr, iter, ACOC] = SOR2(A, b, x0, w, tol, maxiter)
% Aproxima la solucion Ax = b usando el metodo de sobre-relajacion SOR2
% PARAMETROS:
