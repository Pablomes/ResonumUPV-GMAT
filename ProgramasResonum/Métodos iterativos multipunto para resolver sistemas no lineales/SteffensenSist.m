function [sol, incr, incr2, iter, ACOC] = SteffensenSist(F, x0, tol, maxiter)
% [sol, incr, incr2, iter, ACOC] = SteffensenSist(F, x0, tol, maxiter)
% Aproxima la solucion F(x) = 0 usando el metodo libre de jacobianas de
% Steffensen
% PARAMETROS:
