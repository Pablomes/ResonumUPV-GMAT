...
% [sol, incr, incr2, iter, ACOC] = OstrowskiSist(F, dF, x0, tol, maxiter)
% Aproxima la solucion F(x) = 0 usando el metodo multipaso de Ostrowski
% Nota: Se recomienda el uso de vpa() introduciendo x0 como vpa(x0)
% PARAMETROS:
