function [sol, incr, iter, resid, ACOC] = Practica2_GradienteConjugado(A, b, x0, tol, maxiter)
% [sol, incr, iter, resid, ACOC] = Practica2_GradienteConjugado(A, b, x0, tol, maxiter)
